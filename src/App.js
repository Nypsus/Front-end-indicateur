...
const getConversionRate = async (crypto) => {
  try {
    ...
    const response = await axios.get(`https://serveur-api-coingeko-production-0f28.up.railway.app/convert/${cryptoForAPI}`);
...
const getBNBToUSDTRate = async () => {
  try {
    const response = await axios.get('https://serveur-api-coingeko-production-0f28.up.railway.app/price');
